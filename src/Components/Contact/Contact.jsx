        ...
        <>
            ...
            <div className='map '>
                <div className='  container mx-auto'>
                    ...
                    <p className='text-lg text-amber-200 text-center'>SEND US A MASSEGE</p>


                    <form className='lg:w-[700px] mx-auto mt-[20px]'>
                        <div className='  '>
                    ...
                    <div className='mt-[50px] rounded-[10px]'>
                    ...
                    <div className='mt-[100px] pb-[50px] lg:flex gap-[30px] justify-center '>
