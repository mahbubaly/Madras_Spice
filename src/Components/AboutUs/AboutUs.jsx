        ...
        <>
            <div>
                <div className='aboutUsBG lg:h-[700px] '>
                    ...
                    <div className='lg:bg-black bg-gradient-to-r from-black p-5 lg:p-0 to-pink-500
                      lg:h-[700px]   lg:opacity-50'>
                        <div className='container  mx-auto lg:border-b-2 border-white lg:w-[500px] rounded-[10px]'>
            ...
            <div className='choiceUs'>
                <div className='container mx-auto'>
                    <div className='lg:flex justify-center mt-[50px] gap-[60px] items-center'>
                        ...
                        <div className='lg:w-[500px] mt-[50px] lg:mt-0 text-white'>
                    ...
                    <div className='mt-[50px] lg:mt-[100px] text-white'>
                        <h1 className='lg:text-[45px] text-[28px] font-semibold text-center text-yellow-300'>WHY CHOOSE US</h1>
                        <p className='text-lg font-medium text-center '>SOME OF OUR FEATURE</p>


                        <div className='mt-[50px] lg:mt-[100px] lg:flex gap-[30px] justify-center lg:pb-[50px]'>
